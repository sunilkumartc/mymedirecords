...
class DBHandler:
    def __init__(self):
        ...
        self.update_status = """UPDATE tblreports SET status = %s, doctor_name = %s WHERE patientid = %s and reportid = %s"""
    ...
    def dump_test_results(self, patient_id, report_id, results):
        try:
            with self.conn.cursor() as cur:
                ...
                cur.execute(self.update_status, (1, doctor_name, patient_id, report_id,))
